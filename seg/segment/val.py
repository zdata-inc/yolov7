...
from yolov7.seg.utils.general import (LOGGER, NUM_THREADS, Profile, check_dataset, check_img_size, check_requirements, check_yaml,
                           coco80_to_coco91_class, colorstr, increment_path, non_max_suppression, print_args,
                           scale_coords, xywh2xyxy, xyxy2xywh)
from yolov7.seg.utils.metrics import ConfusionMatrix, box_iou
from yolov7.seg.utils.plots import output_to_target, plot_val_study
from yolov7.seg.utils.segment.dataloaders import create_dataloader
from yolov7.seg.utils.segment.general import mask_iou, process_mask, process_mask_upsample, scale_masks
from yolov7.seg.utils.segment.metrics import Metrics, ap_per_class_box_and_mask
...
def run(
    ...
    for batch_i, (im, targets, paths, shapes, masks, adds, dels) in enumerate(pbar):
        ...
        # Loss
        if compute_loss:
            loss += compute_loss(train_out, targets, masks, adds, dels.to(device))[1]  # box, obj, cls
