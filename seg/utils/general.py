...
from yolov7.seg.utils import TryExcept
from yolov7.seg.utils.downloads import gsutil_getsize
from yolov7.seg.utils.metrics import box_iou, fitness
...
def strip_optimizer(f='best.pt', s=''):  # from yolov7.seg.utils.general import *; strip_optimizer()
